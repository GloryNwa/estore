...
<body class="expand-data panel-data">
  ...
  <header class="side-header expand-header" style="background-color:#16183d;">
    ...
    <!-- Page Top --><!--  <form method="POST" action="{{url('/search')}}" >
                   {{csrf_field()}}
                  <button type="submit">
        ...
        <div class="filter-items">
            <div class="row grid-wrap mrg20">
             ...
             @endif   
                 ...
                 <h4 class="widget-title">Total Orders</h4>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <span class="date"style=" font-size: 17px">{{$product->name}}</span>
                                             <a href='{{url("/edit_orders/{$product->id}")}}'>
                                        ...
                                        <td>
                                         ...
                                         <td>
                                            <span class="addr">{{$product->currency}}</span>
                                        </td>
                                        <td>
                                      @if($product->status == 'pending')
                                        ...
                                        @endif
                                           ...
                                           <!--  <span class="addr">{{$product->status}}</span> -->
                                        </td>
